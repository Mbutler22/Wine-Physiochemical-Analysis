...
Model: KNeighborsClassifier T
rain score: 0.8198498748957465 
Test Score: 0.7025
...
3.	Dasa/Joshua/Tinuola - Machine Learning : we plan to use LinearRegression, RandomForestClassifier, Deep Neural to train models and evaluate models using testing data to choose the model with highest performance score
